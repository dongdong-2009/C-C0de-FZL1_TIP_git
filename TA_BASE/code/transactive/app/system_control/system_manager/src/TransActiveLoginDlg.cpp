...
END_MESSAGE_MAP()
    ...
    void TransActiveLoginDlg::onOK() 
    {
        ...
        catch (const TA_Base_Core::AuthenticationAgentException&)
        {
            ...
            UINT selectedButton = showMsgBox(IDS_UI_020018);            
                ...
                case(TA_Base_Core::GenericGUIException::ACCESS_DENIED):
						 {
							 ...
							 UINT selectedButton = showMsgBox(IDS_UE_010021, userName, actionName);
							 FUNCTION_EXIT;
							 return;
						 }
                default:
    ...
    void TransActiveLoginDlg::retrieveConsoleInfo()
    {
        ...
        try
        {
	        TA_Base_Core::IConsolePtr console(TA_Base_Core::ConsoleAccessFactory::getInstance().getConsoleFromAddress(hostName));
