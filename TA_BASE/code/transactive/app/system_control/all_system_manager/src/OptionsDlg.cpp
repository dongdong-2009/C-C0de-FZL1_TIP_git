/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4677_ALL_TIP/TA_BASE/transactive/app/system_control/system_manager/src/OptionsDlg.cpp $
...
namespace TA_Base_App
{
    ...
    BOOL OptionsDlg::OnInitDialog()
    {
        ...
        std::vector<int> intervals = AdminManager::getRefreshIntervals();
        ...
        m_RefreshRate.SetCurSel(AdminManager::getCurrentRefreshRate());
    ...
    {
        AdminManager::setRefreshRate(m_RefreshRate.GetCurSel());
