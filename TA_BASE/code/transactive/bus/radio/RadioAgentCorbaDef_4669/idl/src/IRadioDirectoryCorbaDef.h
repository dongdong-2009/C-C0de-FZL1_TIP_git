...
#ifndef __TA__Base__Bus_mIRadioDirectoryCorbaDef__
#define __TA__Base__Bus_mIRadioDirectoryCorbaDef__
...
_CORBA_MODULE_BEG
  ...
  class IRadioDirectoryCorbaDef :
    public virtual TA_Base_Bus::_impl_IRadioDirectoryCorbaDef,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~IRadioDirectoryCorbaDef();

    inline ::TA_Base_Bus::IRadioDirectoryCorbaDef_ptr _this() {
      return (::TA_Base_Bus::IRadioDirectoryCorbaDef_ptr) _do_this(::TA_Base_Bus::IRadioDirectoryCorbaDef::_PD_repoId);
    }
  };
...
void operator<<=(::CORBA::Any& _a, TA_Base_Bus::IRadioDirectoryCorbaDef_ptr _s);
void operator<<=(::CORBA::Any& _a, TA_Base_Bus::IRadioDirectoryCorbaDef_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, TA_Base_Bus::IRadioDirectoryCorbaDef_ptr& _s);



inline void
TA_Base_Bus::IRadioDirectoryCorbaDef::_marshalObjRef(::TA_Base_Bus::IRadioDirectoryCorbaDef_ptr obj, cdrStream& s) {
